/// @func ST_StringStartsWith(_string, _substr)
///
...
function ST_StringStartsWith(_string, _substr)
{
	gml_pragma("forceinline");
	return (string_pos(_substr, _string) == 1);
}

/// @func ST_StringSplitOnFirst(_string, _delimiter[, _dest])
///
...
function ST_StringSplitOnFirst(_string, _delimiter, _dest=[])
{
...
/// @func ST_StringExplode(_string, _char, _dest)
///
...
function ST_StringExplode(_string, _char, _dest)
{
	static _temp = array_create(2);
	var i = 0;
	do
	{
		ST_StringSplitOnFirst(_string, _char, _temp);
		_dest[@ i++] = _temp[0];
		_string = _temp[1];
	}
	until (_temp[1] == "");
...
/// @func ST_StringJoinArray(_separator, _array)
///
/// @desc Joins an array into a string, putting separator inbetween each
/// entry.
///
...
function ST_StringJoinArray(_separator, _array)
{
	var _string = "";
	var i = 0;
